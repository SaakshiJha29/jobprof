...
export default function CostCalculator({ onOpenAuth }) {
  const [dailyRequests, setDailyRequests] = useState(250000);
  const [targetPlatforms, setTargetPlatforms] = useState(3);
    ...
    <section id="cost-calculator" className="py-20 bg-slate-50 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ScrollReveal>
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-5xl font-extrabold text-slate-900 tracking-tight mb-4">
              Calculate Your <span className="gradient-headline-cyber">Scraping ROI & Savings</span>
            </h2>
        ...
        <ScrollReveal delay={0.2}>
          <div className="glass-panel rounded-3xl p-6 sm:p-10 border border-white shadow-xl">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-7 space-y-8 text-left">
                <div className="bg-indigo-50/60 p-5 rounded-2xl border border-indigo-100">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="px-3 py-1 bg-white text-indigo-700 font-extrabold text-sm rounded-xl border border-indigo-200 font-mono shadow-2xs">
              ...
              <div className="lg:col-span-5 bg-slate-900 text-white rounded-3xl p-8 border border-slate-800 shadow-2xl text-left relative overflow-hidden">
                ...
                <span className="text-xs font-bold uppercase tracking-wider text-indigo-400 font-mono block mb-2">
                ...
                <div className="space-y-3 pt-6 border-t border-slate-800 text-xs font-mono mb-8">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-indigo-300 font-bold">${scrapePulseTotal.toLocaleString()}/mo</span>
                  </div>
                </div>

                <button
                  onClick={onOpenAuth}
                  className="w-full py-3.5 px-6 font-bold text-xs text-white bg-indigo-600 hover:bg-indigo-700 rounded-2xl shadow-lg shadow-indigo-500/25 transition-all interactive flex items-center justify-center gap-2"
                >
