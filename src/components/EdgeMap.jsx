    ...
    <section id="edge-map" className="py-20 bg-slate-900 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-12">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 bg-sky-950/80 border border-sky-800 text-sky-400 rounded-full text-xs font-bold uppercase tracking-wider mb-4">
        ...
        <div className="relative rounded-3xl bg-slate-950/90 border border-slate-800 shadow-2xl overflow-hidden p-6 lg:p-8">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mb-6 pb-4 border-b border-slate-800">
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2 px-3 py-1 bg-sky-950/90 border border-sky-800 text-sky-400 rounded-full text-xs font-mono">
          ...
          <div className="relative w-full h-[360px] sm:h-[480px] bg-slate-950 bg-grid-matrix rounded-2xl border border-slate-800/80 overflow-hidden flex items-center justify-center">
            ...
            {/* Animated SVG Rays connecting US-East to other nodes */}
                ...
                >
                  ...
                  <span className="relative flex h-6 w-6 items-center justify-center">
                    ...
                    <span
                      className={`relative inline-flex rounded-full h-3 w-3 shadow-lg ${
                        isSelected
                          ? 'bg-sky-400 ring-4 ring-sky-500/40'
                  ...
                  <div
                    className={`absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2.5 py-1 rounded-md text-[11px] font-mono whitespace-nowrap border transition-all ${
                      isSelected
                        ? 'bg-sky-600 text-white border-sky-400 shadow-lg scale-105'
            ...
            {/* Floating Live Regional Telemetry Box */}
            <div className="absolute bottom-4 left-4 right-4 sm:left-auto sm:right-4 sm:w-80 bg-slate-900/95 border border-sky-500/40 rounded-2xl p-4 backdrop-blur-md shadow-2xl z-30">
              ...
              <div className="grid grid-cols-2 gap-3 text-xs font-mono mb-3">
                <div className="bg-slate-950 p-2 rounded-lg border border-slate-800">
                  ...
                  <strong className="text-sky-400 text-sm">{selectedRegion.latency}</strong>
                </div>
                <div className="bg-slate-950 p-2 rounded-lg border border-slate-800">
              ...
              <div className="space-y-1.5 text-[11px] font-mono text-slate-300">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-sky-300 font-semibold">{selectedRegion.fingerprint}</span>
                </div>
              </div>
            </div>
