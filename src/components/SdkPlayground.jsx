        ...
        <ScrollReveal>
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-5xl font-extrabold tracking-tight mb-4">
              Production-Ready <span className="bg-gradient-to-r from-indigo-400 via-indigo-300 to-emerald-400 bg-clip-text text-transparent">API Generators</span>
            </h2>
          ...
          <div className="rounded-3xl bg-slate-950 border border-slate-800 shadow-2xl p-6 lg:p-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                  ...
                  <div className="p-3 bg-slate-900 rounded-2xl border border-slate-800">
                    ...
                    <div className="grid grid-cols-3 gap-2 text-xs font-mono">
                      <button
                        ...
                        className={`py-1.5 rounded-lg border ${geoTarget === 'us' ? 'bg-indigo-600 border-indigo-400 text-white' : 'bg-slate-950 border-slate-800 text-slate-400'}`}
                      >
                        US-East
                      </button>
                      <button
                        onClick={() => setGeoTarget('eu')}
                        className={`py-1.5 rounded-lg border ${geoTarget === 'eu' ? 'bg-indigo-600 border-indigo-400 text-white' : 'bg-slate-950 border-slate-800 text-slate-400'}`}
                      >
                        EU-Central
                      </button>
                      <button
                        onClick={() => setGeoTarget('asia')}
                        className={`py-1.5 rounded-lg border ${geoTarget === 'asia' ? 'bg-indigo-600 border-indigo-400 text-white' : 'bg-slate-950 border-slate-800 text-slate-400'}`}
                      >
                        AP-South
                      </button>
                    </div>
              ...
              <div className="lg:col-span-7 rounded-2xl bg-[#080d1a] border border-slate-800 overflow-hidden text-left shadow-2xl">
                ...
                <div className="p-5 font-mono text-xs sm:text-sm text-indigo-300 overflow-x-auto min-h-[320px] leading-relaxed">
                  <pre>
