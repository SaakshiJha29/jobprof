...
export default function DomParserVisualizer() {
  ...
  <div class="salary-container border-indigo-100">$210,000 - $260,000 / yr</div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ScrollReveal>
          <div className="flex flex-col items-center text-center mb-12">
            ...
            <h2 className="text-3xl sm:text-5xl font-extrabold text-slate-900 tracking-tight mb-4">
              Unstructured DOM to <span className="gradient-headline-cyber">Schema.org JSON</span>
            </h2>
        ...
        <ScrollReveal delay={0.1}>
          <div className="flex justify-center mb-8">
            <div className="flex items-center gap-2 bg-white p-1.5 rounded-2xl border border-indigo-200 shadow-sm">
              <button
                onClick={() => setSelectedTarget('linkedin')}
                className={`px-4 py-2 text-xs font-bold rounded-xl transition-all ${
                  selectedTarget === 'linkedin' ? 'bg-indigo-600 text-white shadow-sm' : 'text-slate-600 hover:text-slate-900'
                }`}
              >
                LinkedIn DOM Parser
              </button>
              <button
                ...
                className={`px-4 py-2 text-xs font-bold rounded-xl transition-all ${
                  selectedTarget === 'indeed' ? 'bg-indigo-600 text-white shadow-sm' : 'text-slate-600 hover:text-slate-900'
                }`}
              >
                Indeed Card Parser
              </button>
              <button
                ...
                className={`px-4 py-2 text-xs font-bold rounded-xl transition-all ${
                  selectedTarget === 'glassdoor' ? 'bg-indigo-600 text-white shadow-sm' : 'text-slate-600 hover:text-slate-900'
                }`}
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch">
          ...
          <ScrollReveal delay={0.2} direction="left">
            <div className="glass-panel rounded-3xl p-6 flex flex-col justify-between text-left h-full">
              <div>
                ...
                <div className="p-4 bg-slate-900 rounded-2xl font-mono text-xs text-indigo-300 overflow-x-auto leading-relaxed border border-slate-800 shadow-inner">
                  <pre>
          ...
          <ScrollReveal delay={0.3} direction="right">
            <div className="rounded-3xl bg-[#090e1a] border border-slate-800 shadow-2xl p-6 flex flex-col justify-between text-left h-full">
              <div>
              ...
              <div className="mt-4 pt-3 border-t border-slate-800 flex items-center justify-between text-xs font-mono text-slate-400">
                ...
                <span className="text-indigo-400">Extraction Time: 12ms</span>
              </div>
            </div>
          </ScrollReveal>
