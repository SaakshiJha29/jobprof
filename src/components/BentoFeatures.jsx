      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl font-extrabold text-slate-900 tracking-tight mb-4">
            Unrivaled <span className="gradient-text-hero">Anti-Bot Stealth Capabilities</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 items-stretch">
          ...
          <div className="md:col-span-2 lg:col-span-2 bento-card bento-glow-sky rounded-3xl p-8 flex flex-col justify-between text-left relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-48 h-48 bg-gradient-to-bl from-sky-300/30 to-transparent rounded-bl-full pointer-events-none" />

            <div>
              <div className="flex items-center justify-between mb-6">
                <div className="w-12 h-12 bg-sky-500 text-white rounded-2xl flex items-center justify-center shadow-lg shadow-sky-500/25">
                  <ShieldCheck className="w-6 h-6" />
                </div>
                <span className="text-[11px] font-mono font-bold text-sky-700 bg-sky-100 px-3 py-1 rounded-full border border-sky-200">
            ...
            <div className="bg-slate-900 text-sky-300 p-4 rounded-2xl font-mono text-xs border border-slate-800 flex items-center justify-between">
          ...
          <div className="bento-card rounded-3xl p-6 flex flex-col justify-between text-left relative overflow-hidden group">
            <div>
              <div className="w-10 h-10 bg-sky-100 text-sky-600 rounded-xl flex items-center justify-center mb-4 border border-sky-200">
            ...
            <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-[11px] font-mono text-slate-500">
              ...
              <span className="text-sky-600 font-bold">Auto-Failover</span>
            </div>
          </div>
          ...
          <div className="bento-card rounded-3xl p-6 flex flex-col justify-between text-left relative overflow-hidden group">
            ...
            <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-[11px] font-mono text-slate-500">
              ...
              <span className="text-sky-600 font-bold">Stream Sink</span>
            </div>
          </div>

          {/* Card 5: Financial SLA Guarantee */}
          <div className="md:col-span-2 lg:col-span-3 bento-card bento-glow-sky rounded-3xl p-6 flex flex-col sm:flex-row items-center justify-between text-left relative overflow-hidden">
